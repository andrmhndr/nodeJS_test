...
class UpdateActivitiesPage extends StatefulWidget {
  ...
  @override
  State<UpdateActivitiesPage> createState() => _UpdateActivitiesPageState();
}

class _UpdateActivitiesPageState extends State<UpdateActivitiesPage> {
  ...
  @override
  void initState() {
    controllerName.text = widget.activities.name;
    controllerStartTime.text =
        Converter.dateFormat(value: widget.activities.startTime);
    controllerEndTime.text =
        Converter.dateFormat(value: widget.activities.endTime);

    startTime = TimeOfDay.fromDateTime(widget.activities.startTime);
    endTime = TimeOfDay.fromDateTime(widget.activities.startTime);
    startDate = widget.activities.startTime;
                  ...
                  return ElevatedButton(
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        context
                            .read<ActivitiesBloc>()
                            .add(ActivitiesUpdateItem(activities: activities));
                        Get.back();
                      }
                    },
                    child: Container(
